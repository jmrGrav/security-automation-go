...
**Status: v1.6.4** — provider credential-store hotfix, first-run wizard, encrypted CredentialStore, CrowdSec Go integration, SQLite as single source of truth for feature flags, admin recovery CLI. Production-ready.
