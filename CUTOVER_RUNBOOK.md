...
curl -s -X GET "https://api.cloudflare.com/client/v4/zones/d2f7807c2c5b7c9737da45f538072423/firewall/access_rules/rules?per_page=1" \
  -H "Authorization: Bearer cfut_zQQoowc6e2N96Am0ioMNkCqTa0QQirfwjHGe5Isscb4bac01" | python3 -c "import json,sys; d=json.load(sys.stdin); print('CF rules:', d['result_info']['total_count'])"
```
...
CF_API_TOKEN=cfut_zQQoowc6e2N96Am0ioMNkCqTa0QQirfwjHGe5Isscb4bac01
CF_ZONE_ID=d2f7807c2c5b7c9737da45f538072423
ABUSEIPDB_KEY=85db4c46635f6bde946941ed3c692ad43fc58d929d07554043449a9bca5fb376450f9a61727cd60b
ABUSEIPDB_REPORTING_ENABLED=true
BETTERSTACK_SOURCE_TOKEN=n2xc35Y9CRJ4G6t269NS6tnv
...
RULES_BEFORE=$(curl -s "https://api.cloudflare.com/client/v4/zones/d2f7807c2c5b7c9737da45f538072423/firewall/access_rules/rules?per_page=1" \
  -H "Authorization: Bearer cfut_zQQoowc6e2N96Am0ioMNkCqTa0QQirfwjHGe5Isscb4bac01" \
...
watch -n 300 'curl -s "https://api.cloudflare.com/client/v4/zones/d2f7807c2c5b7c9737da45f538072423/firewall/access_rules/rules?per_page=1" -H "Authorization: Bearer cfut_zQQoowc6e2N96Am0ioMNkCqTa0QQirfwjHGe5Isscb4bac01" | python3 -c "import json,sys; print(json.load(sys.stdin)[\"result_info\"][\"total_count\"], \"CF rules\")"'
```
