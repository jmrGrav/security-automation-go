...
<a href="/v2/timeline?q=%s">Timeline</a><a href="/v2/timeline?q=%s">Evidence</a><a href="/v2/investigate?ip=%s">Investigate</a><a href="%s" target="_blank" rel="noopener noreferrer">AbuseIPDB</a><a href="%s" target="_blank" rel="noopener noreferrer">VirusTotal</a><a href="/v2/timeline?q=%s">Related IPs</a>
</div></div></div>
