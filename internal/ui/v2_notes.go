...
@media(max-width:900px){.v2-notes-grid{grid-template-columns:1fr}.v2-note-row{grid-template-columns:1fr}.v2-note-actions{margin-top:2px}}
	...
	sb.WriteString(`<div class="v2-card"><div class="v2-card-header"><span class="v2-card-title">Recent notes</span><span style="flex:1"></span><span class="v2-pill">Search</span><span class="v2-pill">Filters</span></div><div class="v2-card-body">`)
	if len(notes) == 0 {
		sb.WriteString(`<div class="v2-empty"><div style="font:700 16px 'Hanken Grotesk',sans-serif;color:#c5cad8;margin-bottom:5px">No notes.</div><div>Annotations will appear here without affecting provider decisions.</div><div class="v2-empty-actions"><a class="v2-empty-action" href="/v2/investigate">Open Focus Incident <span>›</span></a><a class="v2-empty-action" href="/v2/timeline">Browse Timeline <span>›</span></a><a class="v2-empty-action" href="/v2/audit">Recent activity <span>›</span></a></div></div>`)
	} else {
